...
cat <<EOF
configVersion: v1
# Maybe it's wise to prevent the reaper to terminate 100 pods ate the same time.
# Uncomment the below settings in this have any relevance for your situation.
#settings:
